...
if (!$order_id) {
    header('Location: ' . BASE_PATH . '/freelancer/orders.php');
    exit;
}
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo BASE_PATH; ?>/freelancer/orders.php" class="btn btn-secondary">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php if ($order['client_notes']): ?>
                        <div class="mt-3">
                            <h6 style="color: var(--text-primary);">Client Notes</h6>
                            <p style="color: var(--text-secondary);">
                                <?php echo nl2br(htmlspecialchars($order['client_notes'])); ?>
                            </p>
                        </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="mailto:<?php echo htmlspecialchars($order['client_email']); ?>" class="btn btn-primary btn-sm mt-2">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo BASE_PATH; ?>/freelancer/orders.php" class="btn btn-secondary btn-sm w-100">
                        <i class="fas fa-arrow-left"></i> Back to Orders
                    </a>
                </div>
            </div>
